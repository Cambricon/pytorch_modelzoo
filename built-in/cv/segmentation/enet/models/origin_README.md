...
```
python main.py [--mode {train,test,full}] [--resume]
               ...
               [--weighing {enet,mfb,none}] [--with-unlabeled] [--seed SEED]
               [--deterministic] [--warmup WARMUP] [--iters ITERS]
               [--workers WORKERS] [--local_rank LOCAL_RANK]
               [--dist-backend DIST_BACKEND] [--distributed]
               [--dist-url DIST_URL] [--print-step] [--imshow-batch]
