...
def write_voc_results_file(all_boxes, dataset,image_num):
...
def test_net(save_folder, net, cuda, dataset, transform, top_k,
    ...
    evaluate_detections(all_boxes, output_dir, dataset,image_num = num_images)


def evaluate_detections(box_list, output_dir, dataset,image_num):
    write_voc_results_file(box_list, dataset,image_num)
...
if __name__ == '__main__':
    ...
    ckpt = torch.load(args.trained_model, map_location=torch.device('cpu'))       # initialize SSD
    if args.pyamp or args.cnmix:
