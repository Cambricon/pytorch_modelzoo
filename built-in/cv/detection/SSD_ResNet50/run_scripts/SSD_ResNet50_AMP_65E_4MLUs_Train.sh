...
set -e
epoch=65 #default
SAVE_CHECKPOINT_PATH=$PROJ_DIR/data/mlu_trained_checkpoint/SSD_ResNet50_${epoch}E_AMP_4MLUs
SAVE_RESULT_PATH=$PROJ_DIR/data/output/train/SSD_ResNet50_${epoch}E_AMP_4MLUs
