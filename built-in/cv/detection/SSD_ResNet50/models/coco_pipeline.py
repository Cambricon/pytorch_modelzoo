...
try:
    ...
    print("import nvidia dali failed")
try:
    import cambricon.dali as dali
    from cambricon.dali.pipeline import Pipeline
    DATA_BACKEND_CHOICES.append("dali-mlu")
except ImportError:
    print("import cambricon dali failed")
...
class COCOPipeline(Pipeline):
    def __init__(self, batch_size, file_root, annotations_file, default_boxes,
                 ...
                 num_threads=1, seed=15, device='cpu'):
    ...
    def __next__(self):
        ...
        for i in range(self._num_gpus):
            ...
            if self._device == "gpu":
                ...
                #TODO(xushuo): change cpu to mlu
                torch_gpu_device = torch.device('cpu')
