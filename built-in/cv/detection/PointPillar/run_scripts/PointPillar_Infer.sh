...
bash scripts/dist_test.sh 1 --cfg_file cfgs/nuscenes_models/cbgs_pp_multihead.yaml --fix_random_seed --device mlu --set OPTIMIZATION.BATCH_SIZE_PER_GPU 2 OPTIMIZATION.LR 0.003 OPTIMIZATION.LR_WARMUP True
