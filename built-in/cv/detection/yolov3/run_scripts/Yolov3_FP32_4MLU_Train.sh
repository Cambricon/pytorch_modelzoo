...
python train.py --distributed --dist-backend cncl --batch-size $batch_size --weights $weights --cfg $cfg --data $data --ckp-path $ckp_dir --logdir $log_dir --notest --device "mlu"
popd
