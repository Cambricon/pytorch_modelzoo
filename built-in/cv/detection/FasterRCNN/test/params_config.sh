...
base_params () {
    ...
    num_workers="0"
    evaluate="False";
    output="${CONFIG_DIR}/fasterrcnn"

    benchmark_mode="True"
    max_batch_size_MLU290="2"
    max_batch_size_MLU370="8"
    max_batch_size_MLU590_M9="24"
    max_batch_size_MLU590_M9U="24"
    max_batch_size_MLU590_H8="24"
...
set_configs () {
    ...
    do
        case "$var" in
            ...
            ddp)    ddp="True";
		    base_iters=10000;
		    ckpt="${PYTORCH_TRAIN_CHECKPOINT}/rcnn/fasterrcnn/checkpoints_fp/model_0010000.pth" ;;
