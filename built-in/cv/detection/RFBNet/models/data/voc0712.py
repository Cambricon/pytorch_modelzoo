...
class VOCDetection(data.Dataset):
    ...
    def __init__(self, root, save_folder, image_sets, preproc=None, target_transform=None,
    ...
    def __getitem__(self, index):
        #print('index=', index) random if not seeded
        img_id = self.ids[index]
        ...
        if self.preproc is not None:
            ...
            #print('VOCDetection--__getitem__')
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(
            ...
            self.save_folder, 'results', 'VOC' + self._year, 'Main')
    ...
    def _do_python_eval(self, output_dir='output'):
        ...
        cachedir = os.path.join(self.save_folder, 'annotations_cache')
        aps = []
        ...
        metric_collector.insert_metrics(
                net = "RFBNet",
                accuracy = [round(np.mean(aps),3), "mAP"])
