...
python $CUR_DIR/../../classify_train.py -a resnet50 --iters -1 --batch-size 64 --lr 0.1 --device mlu --momentum 0.9  --wd 1e-4  --seed 42 --data $IMAGENET_TRAIN_DATASET --logdir $CUR_DIR/../../data/output/resnet50_fp32_four_card_log --epochs 100 --save_ckp --ckpdir $CUR_DIR/../../data/output/resnet50_fp32_four_card_ckps --multiprocessing-distributed -j8 --dist-backend cncl --world-size 1 --rank 0 --cnmix --opt_level O0
