...
training_opt['log_dir'] = './logs/ImageNet_LT/imagenet_mid_stage1'
training_opt['num_classes'] = 1000  # 379
training_opt['batch_size'] = 128
training_opt['num_workers'] = 0
training_opt['num_epochs'] = 50
...
feature_optim_param = {'lr': 1e-3, 'momentum': 0.9, 'weight_decay': 0.0005}
