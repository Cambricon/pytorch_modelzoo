...
training_opt['log_dir'] = './logs/ImageNet_LT/brand_mid_meta_embedding'
training_opt['num_classes'] = 379
...
feature_param = {'use_modulatedatt': True, 'use_fc': True, 'dropout': None,
                 'stage1_weights': True, 'dataset': training_opt['dataset'],'weightpath':'brand_mid_stage1'}
