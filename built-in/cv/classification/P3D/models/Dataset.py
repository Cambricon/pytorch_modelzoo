...
class MyDataset(Dataset):
    def __init__(self, root_path, data_folder='/algo/modelzoo/datasets/UCF101/rgb',table_folder='train', name_list='ucfTrainTestlist', version=1, transform=None, num_frames=16, modality='RGB', random=False):
