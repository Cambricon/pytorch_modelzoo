...
CONTAINER_NAME=mlu_bert_base_cased
...
docker run --device /dev/cambricon_ctl --network host --ipc=host  -it --privileged --name $CONTAINER_NAME -v /your/data:/your/data -v /your/ckpt:/your/ckpt -v /usr/bin/cnmon:/usr/bin/cnmon -e SQUAD_DIR=$SQUAD_DIR -v $PWD/../../..:/home/pytorch_modelzoo -w /home/pytorch_modelzoo/built-in/nlp/bert-base-cased/ $IMAGE_NAME /bin/bash
else
