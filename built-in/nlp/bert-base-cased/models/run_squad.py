...
def train(args, train_dataset, model, tokenizer):
    ...
    metric_collector = MetricCollector(
            ...
            record_hardware_time=True if args.device_param == "mlu" else False)
...
def main():
    ...
    parser.add_argument("--device_param", type=str, default="mlu", help="use gpu, mlu or cpu")
    parser.add_argument(
    ...
    if args.local_rank == -1:
        ...
        device = torch.device("cuda" if torch.cuda.is_available() and args.device_param == "gpu" else args.device_param, args.local_rank)
        torch.distributed.init_process_group(backend='cncl' if args.device_param == "mlu" else "nccl", init_method='env://')
    args.n_device = 1
    args.device = device
    ...
    if os.getenv('AVG_LOG') and (args.local_rank <= 0):
        ...
        metric_collector.insert_metrics(net = "bert-base-cased",
                                        accuracy = result['f1'])
        metric_collector.dump()
